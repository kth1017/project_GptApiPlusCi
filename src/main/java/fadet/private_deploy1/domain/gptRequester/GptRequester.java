...
public class GptRequester {
    ...
    // 서비스용
    public GptRequester(String question, ApiKey apikey){
        this.question = question;
        this.answer = incoding(apikey);
    }

    // reposit 테스트용
    public GptRequester(String answer) {
        this.answer = answer;
    }
    ...
    public String incoding(ApiKey apiKey) {
        ...
        String text = "{\"model\": \"gpt-3.5-turbo-instruct\", \"prompt\": \""+question+"\", \"temperature\": 0.1, \"max_tokens\":1280}";
